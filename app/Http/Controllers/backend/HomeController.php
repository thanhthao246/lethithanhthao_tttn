...
class HomeController extends Controller
{
    ...
    //    $brand_product = DB::table('lttt_brand')->where('brand_status','0')->orderby('brand_id','desc')->get(); 

    //    $search_product = DB::table('lttt_product')->where('product_name','like','%'.$keywords.'%')->get(); 
